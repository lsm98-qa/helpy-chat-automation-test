...
# =========================
def test_agent_search_shows_result_list(navigate_to_agent_explore, wait):
    # ==========
    # Arrange
    # ==========
    driver = navigate_to_agent_explore
...
# =========================
def test_agent_search_hides_empty_state_when_results_exist(navigate_to_agent_explore, wait):
    # ==========
    # Arrange
    # ==========
    driver = navigate_to_agent_explore
...
# =========================
def test_agent_search_returns_titles_related_to_keyword(navigate_to_agent_explore, wait):
    # ==========
    # Arrange
    # ==========
    driver = navigate_to_agent_explore
